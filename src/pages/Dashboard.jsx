...
function Dashboard(){
    ...
    const colors = ["#34D399", "#60A5FA", "#F472B6", "#A78BFA", "#FBBF24", "#F87171"];
            ...
            <div className="p-4 max-w-7xl mx-auto py-8">
              ...
              <div className="flex gap-4">
                ...
                rounded-lg border-2 border-dashed border-gray-300 hover:border-blue-500">
                    <PlusIcon className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-blue-300 to-green-500 text-white 
                    rounded-full"/>
                ...
                rounded-lg border-2 border-dashed border-gray-300 hover:border-purple-500">
                    <UploadCloudIcon className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-pink-300 to-purple-500 text-white 
                    rounded-full"/>
              ...
              <div className="grid grid-col-2 sm:flex flex-wrap gap-4">
                {allResumes.map((resume, index)=>{
                    ...
                    return (
                       <button key={index}  onClick={() => navigate(`/app/builder/${resume._id}`)} className='relative w-full sm:w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 
                        border group hover:shadow-lg transition-all duration-300 cursor-pointer' style={{background:`linear-gradient(135deg, ${baseColor}10, ${baseColor}40)`, borderColor: baseColor + '40'}}> 
                          ...
                          <p className="absoulate bottom-1 text-slate-400 group-hover:text-slate-500 transition-all duration-300 px-2 text-center" style={{color: baseColor + '90'}}>Updated on {new Date(resume.updatedAt).toLocaleDateString()}</p>
