...
function Login(){
    ...
    return (
        <div className="flex flex-center justify-center min-h-screen bg-gray-100 ">
             <form onSubmit={handleSubmit} className="sm:w-[350px] w-full h-120 text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
